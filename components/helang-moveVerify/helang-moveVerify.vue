...
<script>
	export default {
		...
		methods: {
			...
			/* 滑动结束 */
			onEnd() {
					console.log(this.size.pathway+'a');
				if (this.isOk) {
					this.isMove=true;
					return;
				}
