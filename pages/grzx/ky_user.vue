	...
	<view class="content">
		...
		<view class="serviceBox">
			...
			<view class="boxClass" @click="QQClick">
				<image src="../../static/grzx/tubiao_kefu.png" class="iconClass1"></image>
			...
			<view class="boxClass borderTop" @click="navTo('/pages/grzx/set')">
				<image src="../../static/grzx/tubiao_shezhi.png" class="iconClass4"></image>
