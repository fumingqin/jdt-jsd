	...
	<view>
		...
		<view style="width: 94%;height: 1086rpx; position: absolute;background-color: #FFFFFF;margin-left: 22rpx; border-radius:20rpx; margin-top: -120rpx;">
			...
			<view style=" align-items: center; justify-content: space-between;">
				<text style="width:371rpx;height:35rpx;font-size:36rpx;font-family:Source Han Sans SC;font-weight:400;color:rgba(51,51,51,1);line-height:36rpx; margin-left: 260rpx;">提醒成功！</text>
			</view>
		</view>
	</view>
</template>
